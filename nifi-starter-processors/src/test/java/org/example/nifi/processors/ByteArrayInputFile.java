...
/**
 * A parquet-java {@link InputFile} served from a byte array, for tests only.
 *
 * <p>Production code streams from the content repository through {@link FlowFileInputFile}. Tests
 * need to inspect Parquet bytes they are holding directly, which this makes possible.
 *
