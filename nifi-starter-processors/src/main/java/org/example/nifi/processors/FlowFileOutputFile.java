 ...
 *
 * <p>The asymmetry with reading is worth noting. {@link ByteArrayInputFile} exists because the
 * footer is at the end of the file and a reader has to seek backwards to find it. A writer puts
 * the footer there in the first place, so it has no such problem.
 */
